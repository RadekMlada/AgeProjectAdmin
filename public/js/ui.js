...
$(function () {
    ...
    function toggleAutoHeight() {
        var doToggle = $(window).width() < 650;
        $('#section-media').toggleClass('fp-auto-height', doToggle);
        $('#section-career').toggleClass('fp-auto-height', doToggle);
        $('#section-atelier').toggleClass('fp-auto-height', doToggle);
    }
    ...
    function showFullpage(sectionName) {
        $('#fullpageWrapper').css('display', 'block');
        fullPageMainPage = initFullpage(sectionName);
